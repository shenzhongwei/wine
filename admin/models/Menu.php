...
class Menu extends \yii\db\ActiveRecord
{
    ...
    public function  getAllMenu(){
        $menu = Yii::$app->db->createCommand("SELECT * FROM `wine_admin_menu` WHERE mam_parentid='0' ")->queryAll();
        return $menu;
    }
    //获取所有菜单列表
    public function  getMenuList(){
        $menu = Yii::$app->db->createCommand("SELECT * FROM `wine_admin_menu` ORDER BY mam_order ASC ")->queryAll();
    ...
    public function  getLeftMenuList(){
        ...
        $menu = Yii::$app->db->createCommand("SELECT * FROM `wine_admin_menu` WHERE mam_route IN ($RolesList)  ORDER BY `mam_order` ASC")->queryAll();
    ...
    public function getRouteById($id){
        $router = Yii::$app->db->createCommand("SELECT * FROM `wine_admin_menu` WHERE mam_id='$id'")->queryOne();
        return $router['route'];
    }
