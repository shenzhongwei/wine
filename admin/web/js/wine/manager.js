...
$(function(){
    ...
    $('#manager_update').click(function(){
        var wa_id = $('#admin-wa_id').val();
        var wa_username = $('#admin-wa_username').val();
        var wa_password = $('#admin-wa_password').val();
        var confirm_password = $('#admin-confirm_password').val();
        var wa_phone = $('#admin-wa_phone').val();
        var wa_name = $('#admin-wa_name').val();
    ...
    $('#manager_create').click(function(){
        ...
        var wa_password = $('#admin-wa_password').val();
        var confirm_password = $('#admin-confirm_password').val();
        if(wa_username==''||wa_password==''||confirm_password==''){
...
function searchManager(page){
    ...
    wa_username = $('#searchUsername').val();
    wa_phone = $('#searchPhone').val();
    wa_name = $('#searchName').val();
    wa_type = $('[name="level"]').val();
    csrfToken = $('meta[name="csrf-token"]').attr("content");
    var searchArr = {};
    searchArr['wa_username']=wa_username;
    searchArr['wa_phone']=wa_phone;
    searchArr['wa_name']=wa_name;
    searchArr['wa_type']=wa_type;
    $.ajax({
        statusCode: {
            302: function() {
                layer.alert('登录信息已过期，请重新登录',{icon: 0},function(){
...
var userNameSuggest=$("#searchUsername").bsSuggest({
    url: toRoute('manager/search?key=wa_username&val='),                      //请求数据的 URL 地址
