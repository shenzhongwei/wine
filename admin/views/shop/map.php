...
<script type="text/javascript">
    $(function(){
        shop_lat = ($('#shopinfo-lat').val())/1000000;
        shop_lng = ($('#shopinfo-lng').val())/1000000;
        shop_name = $('#shopinfo-name').val();
        shop_limit = $('#shopinfo-limit').val()*1;
        shop_region = $('#shopinfo-region').val();
        shop_address = $('#shopinfo-address').val();
        $(document).ready(init(shop_lat,shop_lng,shop_name,shop_limit,shop_region,shop_address));

        $('#confirm').on('click',function () {
            $('#shopinfo-province').val($('#province').val());
            $('#shopinfo-city').val($('#city').val());
            $('#shopinfo-district').val($('#district').val());
            $('#shopinfo-region').val($('#region').val());
            $('#shopinfo-address').val($('#address').val());
            $('#shopinfo-lat').val($('#lat').val());
            $('#shopinfo-lng').val($('#lng').val());
        });
    });
