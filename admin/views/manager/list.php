            ...
            <div class="row" style="margin-bottom: 5px">
                <div class="col-lg-2">
                    <div class="input-group">
                        <span class="input-group-addon" style="background-color: #21b9bb;border-color: #21b9bb;color: #FFF;">用户名</span>
                        <input autocomplete="off" style="border-radius: 4px;" class="form-control input-sm" id="searchUsername" type="text"
                               value="<?=empty($searchArr) ? '':(empty($searchArr['wa_username'])? '':$searchArr['wa_username']) ?>"
                            >
                ...
                <div class="col-lg-2">
                    <?= Html::dropDownList('level', empty($searchArr) ? 0:(empty($searchArr['wa_type'])? 0:$searchArr['wa_type']), $itemArr,['prompt' => '请选择用户组', 'class' => 'form-control input-sm','style'=>'font-size:13px']) ?>
                </div>
                <div class="col-lg-3">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <?php foreach($admin as $val):?>
                                        <tr>
                                            <td id="wa_id"><?=$val['wa_id'] ?></td>
                                            <td><?=$val['wa_username'] ?></td>
                                            <td><?='----------' ?></td>
                                            <td><?=$val['wa_phone'] ?></td>
                                            <td><?=$val['wa_name'] ?></td>
                                            ...
                                            <td>
                                                ...
                                                <div class="switch">
                                                    <div class="onoffswitch">
                                                        ...
                                                        if(Yii::$app->user->identity->wa_type >= $val['wa_type']){
                                                            echo 'disabled';
                                                        }else{
                                                            echo '';
                                                        }
                                                        ...
                                                        ?> class="onoffswitch-checkbox" id="admin<?=$val['wa_id'] ?>">
                                                        <label class="onoffswitch-label" for="admin<?=$val['wa_id'] ?>">
